...
.find('img')
.attr('src','http://admin.symfony.fr/plugins/ckeditor-spip-plugin/images/searching.gif');
...
.find('img')
.attr('src','http://admin.symfony.fr/plugins/ckeditor-spip-plugin/images/ckeditor_spip.png')
.end()
.attr('disabled','');
...
.find('img')
.attr('src','http://admin.symfony.fr/plugins/ckeditor-spip-plugin/images/ckeditor.png')
.end()
.attr('disabled','');
$(editor_id)
.attr('disabled','')}
...
+'"><img src="http://admin.symfony.fr/plugins/ckeditor-spip-plugin/images/ckeditor.png"/></button>'}
;
if(buttons)
