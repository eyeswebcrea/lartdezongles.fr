...
.find('img')
.attr('src','http://localadmin.lartdezongles.fr/plugins/ckeditor-spip-plugin/images/searching.gif');
...
.find('img')
.attr('src','http://localadmin.lartdezongles.fr/plugins/ckeditor-spip-plugin/images/ckeditor_spip.png')
.end()
.attr('disabled','');
...
.find('img')
.attr('src','http://localadmin.lartdezongles.fr/plugins/ckeditor-spip-plugin/images/ckeditor.png')
.end()
.attr('disabled','');
$(editor_id)
.attr('disabled','')}
...
+'"><img src="http://localadmin.lartdezongles.fr/plugins/ckeditor-spip-plugin/images/ckeditor.png"/></button>'}
;
if(buttons)
