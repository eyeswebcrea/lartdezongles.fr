...
define('_CKE_JS', find_in_path('lib/ckeditor/ckeditor'.(ckeditor_lire_config('devtools', _CKE_DEVTOOLS_DEF)?'_source':'').'.js')) ;
define('_CKE_JQUERY', find_in_path('lib/ckeditor/adapters/jquery.js')) ;
define('_CKE_SPIP', url_absolue(_DIR_RACINE.'spip.php?page=ckeditor4spip.js')) ;
...
define('_CKE_PREFERED_VERSION', '3.6.1') ;
